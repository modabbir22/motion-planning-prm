...
git clone https://github.com/modabbir22/motion-planning-prm.git
# Enter the directory
...
#### Query 2
![Post-processing Environment 1 Query 2](catkin_ws/output/path_shortcut/prm_env1_q2.png)

#### Query 3
![Post-processing Environment 1 Query 3](catkin_ws/output/path_shortcut/prm_env1_q3.png)

###  Post-processing (PRM + shortcut): Environment 2

#### Query 1
![Post-processing Environment 2 Query 1](catkin_ws/output/path_shortcut/prm_env2_q1.png)

#### Query 2
![Post-processing Environment 2 Query 2](catkin_ws/output/path_shortcut/prm_env2_q2.png)

#### Query 3
![Post-processing Environment 2 Query 3](catkin_ws/output/path_shortcut/prm_env2_q3.png)

#### Query 4
![Post-processing Environment 2 Query 4](catkin_ws/output/path_shortcut/prm_env2_q4.png)

###  II - Post-processing (PRM + shortcut): Environment 3

#### Query 1
![Post-processing Environment 3 Query 1](catkin_ws/output/path_shortcut/prm_env3_q1.png)

#### Query 2
![Post-processing Environment 3 Query 2](catkin_ws/output/path_shortcut/prm_env3_q2.png)
